...
// scripts/gen/gen_xcstrings.py adds to the app string catalog — a key with no entry
...
// that a string key IS its English value (scripts/gen/gen_xcstrings.py). That is not

...
/// `scripts/verify/verify-tmux-scroll.py` independently proves those same bytes scroll
...
struct MoshScrollKeysTests {
    ...
    func inputExitsCopyMode() {
        ...
        // / can't exit" once scrolled. scripts/verify/verify-tmux-scroll.py proves q exits.
...
/// `scripts/verify/verify-tmux-click.py` independently proves tmux delivers them to the

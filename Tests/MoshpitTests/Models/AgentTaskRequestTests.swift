...
struct AgentTaskRequestTests {
    ...
    private func valid() -> AgentTaskRequest {
        AgentTaskRequest(repoPath: "/Users/dev/code/moshpit",
    ...
    func repoName() {
        #expect(valid().repoName == "moshpit")
    }

    @Test("Menu subtitles collapse the home prefix to ~")
    func pathAbbreviation() {
        #expect(AgentTaskRequest.abbreviatePath("/Users/dev/code/moshpit") == "~/code/moshpit")
        #expect(AgentTaskRequest.abbreviatePath("/home/deploy/sample-app") == "~/sample-app")
        #expect(AgentTaskRequest.abbreviatePath("/root/gotools") == "~/gotools")
        #expect(AgentTaskRequest.abbreviatePath("/Users/dev") == "~")

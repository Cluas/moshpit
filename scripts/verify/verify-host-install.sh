...
write_file '$HOME/.moshpit/moshpit-stamp.sh' 755 "$REPO/scripts/host/moshpit-stamp.sh"
WANT=$(shasum -a 256 "$REPO/scripts/host/moshpit-stamp.sh" | awk '{print $1}')
...
say "the sender too"
write_file '$HOME/.moshpit/moshpit-push.sh' 755 "$REPO/scripts/host/moshpit-push.sh"
WANT=$(shasum -a 256 "$REPO/scripts/host/moshpit-push.sh" | awk '{print $1}')

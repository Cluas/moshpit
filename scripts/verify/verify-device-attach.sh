...
# developerservices2 rejects the ASC API key, see scripts/release/release-archive.sh).
...
#
# Usage: scripts/verify/verify-device-attach.sh <device-udid> <host-reachable-from-device>
set -eu

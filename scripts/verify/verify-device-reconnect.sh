...
# skipping that step.
#
# Usage: scripts/verify/verify-device-reconnect.sh <devicectl-udid> <usb-udid> <host-ip>
set -eu
...
# 30-second answered-at-the-desk window (scripts/verify/verify-stamp-quiet.sh covers

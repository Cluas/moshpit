...
public enum PushDiagnostics {
    ...
    public static let source = "push·extension"
    ...
    /// Its own coder: the install engine's shared one is app-only, and this
    /// type has to work in the extension too or it is pointless.
    ...
    public static func record(_ text: String, now: Date = Date()) {
    ...
    /// window.
    public static func recent(since: Date) -> [Line] {

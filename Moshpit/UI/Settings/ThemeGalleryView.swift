...
struct ThemeGalleryView: View {
    ...
    var body: some View {
        ...
        // Selection haptic follows the setting, so a pick made from the editor
        // or an import feels the same as a tap on a row.
        .sensoryFeedback(.selection, trigger: settings.themeId)
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    SectionKicker(title: "THEME JSON")
                } footer: {
                ...
                .listRowBackground(Ink.terminalBG)

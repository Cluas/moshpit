...
/// delivered nowhere else — SwiftUI has no equivalent hook. Keep it an
/// NSObject: as a UIResponder vending `keyCommands` it silently broke every
/// SwiftUI `.keyboardShortcut` in the app.

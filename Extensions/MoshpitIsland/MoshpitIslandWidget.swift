...
// agent Live Activity (see Moshpit/Services/Island/AgentActivityMonitor.swift). One
...
struct LockScreenView: View {
    ...
    /// silently sliced.
    ///
    /// `Tests/MoshpitTests/Island/LockScreenHeightTests.swift` fails if any shape
